...
alias dkr-login-cicd-np='aws --profile cicd-np ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 561618220790.dkr.ecr.us-east-1.amazonaws.com'
alias dkr-login-155-np-us='aws --profile ct155-np-us ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 616418525936.dkr.ecr.us-east-1.amazonaws.com'
